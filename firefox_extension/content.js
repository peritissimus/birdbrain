...
const EXT_RUNTIME = typeof browser !== "undefined" ? browser.runtime : chrome.runtime;
...
function injectHookScript() {
  ...
  if (root.dataset.birdbrainHookInjected === "1") {
    return;
  }
  root.dataset.birdbrainHookInjected = "1";

  const script = document.createElement("script");
  script.src = EXT_RUNTIME.getURL("hook.js");
